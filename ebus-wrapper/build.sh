...
g++ -shared wrapper.o -o wrapper.so -L/opt/pleora/ebus_sdk/Ubuntu-18.04-x86_64/lib -lPvAppUtils -lPtConvertersLib -lPvBase -lPvBuffer -lPvGenICam -lPvSystem -lPvStream -lPvDevice -lPvTransmitter -lPvVirtualDevice -lPvPersistence -lPvSerial -lPvCameraBridge -lPvGUI -lSimpleImagingLib -L../../../lib/genicam/bin/Linux64_x64
